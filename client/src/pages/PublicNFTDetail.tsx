              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  {nft.contractAddress && nft.tokenId && (
                    <a
                      href={`https://opensea.io/assets/${nft.chain || 'ethereum'}/${nft.contractAddress}/${nft.tokenId}`}
                      target="_blank"
                    ...
                    >
                      <Button
                        size="lg"
                        variant="outline"
                        className="w-full border-blue-500/50 hover:bg-blue-500/10 text-blue-400 font-bold"
                      >
