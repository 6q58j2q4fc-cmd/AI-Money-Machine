...
const menuItems: MenuItem[] = [
  ...
  { icon: Shield, label: "NFT Portfolio", path: "/nft-portfolio" },
  { icon: FileText, label: "NFT Blog (SEO)", path: "/nft-blog" },
  { icon: Coins, label: "Real Earnings", path: "/real-earnings" },
